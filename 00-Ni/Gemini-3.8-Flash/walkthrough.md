...
- **Detector Data**: Loaded [Ni.tiff](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni.tiff) ($3888 \times 3072$ pixels) using `fabio` and `easyxrd`.
- **Geometry & Calibration**: Applied [_calibration.poni](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/_calibration.poni) (Dexela2923 detector, sample-to-detector distance $\approx 0.599\text{ m}$, beam center, and $\lambda = 0.01799\text{ nm} = 0.1799\text{ \AA}$).
- **Detector Mask**: Applied [_mask.edf](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/_mask.edf) to remove dead pixels, detector gaps, and the beamstop shadow.
- **Radial Range**: Restricted to $q \in [1.5, 9.5]\text{ \AA}^{-1}$ to eliminate direct beam scatter and noisy edge pixels.
- **Exported 1D Profile**: Saved the integrated 1D powder pattern $I(q)$ vs $q$ as [Ni_1D.xy](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni_1D.xy).

## 2. Decoupled Instrumental Profile

- Calibrated instrumental broadening parameters ($U, V, W, \text{Zero}$) were read directly from [_instrument_parameters.gpx](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/_instrument_parameters.gpx).
...
- [Ni_Rietveld_Refinement.ipynb](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni_Rietveld_Refinement.ipynb): Fully executed Jupyter notebook with all code, markdown notes, inline outputs, and plots.
- [Ni_1D.xy](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni_1D.xy): Radially integrated 1D ASCII profile data ($q$ vs intensity).
- [Ni_refined.gpx](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni_refined.gpx): Complete GSAS-II project file containing the refined histograms, phases, and parameters.
- [Ni_refinement_plot.png](file:///home/mt/repos/easyXRD_with_agents/00-Ni/Gemini-3.8-Flash/Ni_refinement_plot.png): High-resolution refinement plot.
